...
public class InMemoryCurrencyConverter implements CurrencyConverter {
    ...
    public InMemoryCurrencyConverter() {
        this.conversationTable[Currency.RUB.ordinal()][Currency.USD.ordinal()] = 0.0163D;
        this.conversationTable[Currency.RUB.ordinal()][Currency.EUR.ordinal()] = 0.0166D;
        this.conversationTable[Currency.USD.ordinal()][Currency.EUR.ordinal()] = 1.0218D;
        this.conversationTable[Currency.USD.ordinal()][Currency.RUB.ordinal()] = 65D;
        this.conversationTable[Currency.EUR.ordinal()][Currency.USD.ordinal()] = 0.9786D;
